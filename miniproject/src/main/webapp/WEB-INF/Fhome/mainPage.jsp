...
<body>
	...
	<div class=""style =" height:1200px; ">
		...
		<div class= "d-flex flex-column justify-content-center align-items-center" style =" height:1000px;">
		<div class= "row border border-light border-4 py-5 " style =" height:600px; width: 1200px; ">
		<div class= "row my-2 ">
			<div class= "col text-light d-flex justify-content-center fs-1">
				우주최강 프로필
			</div>
		</div>
		<div class= "row my-2">
